...
By running the playbook, the following optional extension modules
would be activated on the target:

* Python 3 -- `sle-module-python3`
* Package Hub -- `PackageHub`
* (Optional: for `docker` installation method) Containers Module 15
x86_64 -- `sle-module-containers/15.x/x86_64`
