...
| trento_prometheus_port | The port where Prometheus is exposed.
  This is the canonical port variable for playbook-managed Prometheus
  and Trento integration. | 9090
