...
This playbook aims to install Trento components and the belonging
third parties. Additionally, API Key for the agents is automatically
retrieved from Trento server and passed to the deployed agents.
