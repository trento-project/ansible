...
| app_web_postgres_host | The host where Postgres database for Web is
  located. This value is ignored when `app_web_postgres_host_group` is
  non-empty string. | localhost

| app_web_postgres_host_group | Name of the host group where Postgres
  database for Web is located. If this value is not empty string,
  activates auto-discovery of the Postgres host by searching it in the
  specified group. When auto-discovery is active, the value of
  `app_web_postgres_host` is ignored. | ""
...
| app_wanda_postgres_host | The host where Postgres database for Wanda
  is located. This value is ignored when
  `app_wanda_postgres_host_group` is non-empty string. | localhost

| app_wanda_postgres_host_group | Name of the host group where
  Postgres database for Wanda is located. If this value is not empty
  string, activates auto-discovery of the Postgres host by searching
  it in the specified group. When auto-discovery is active, the value
  of `app_wanda_postgres_host` is ignored. | ""
...
| app_rabbitmq_host | The host where RabbitMQ is located. It could
  include the service port. This value is ignored when
  `app_rabbitmq_host_group` is non-empty string. | localhost

| app_rabbitmq_host_group | Name of the host group where RabbitMQ is
  located. It could include the service port. If this value is not
  empty string, activates auto-discovery of the RabbitMQ host by
  searching it in the specified group. When auto-discovery is active,
  the value of `app_rabbitmq_host` is ignored. | ""
...
| agent_rabbitmq_host | The host where RabbitMQ is located. It could
  include the service port. This value is ignored when
  `agent_rabbitmq_host_group` is non-empty string. | localhost

| agent_rabbitmq_host_group | Name of the host group where RabbitMQ is
  located. It could include the service port. If this value is not
  empty string, activates auto-discovery of the RabbitMQ host by
  searching it in the specified group. When auto-discovery is active,
  the value of `agent_rabbitmq_host` is ignored. | ""
