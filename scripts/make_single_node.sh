...
printf "ansible-playbook -i $data_dir/inventory.$machine_ip.yml -e @$data_dir/vars.$machine_ip.json site.yml \n"
printf "\n"
printf "or\n\n"
printf "ansible-playbook -i $data_dir/inventory.$machine_ip.ini site.yml \n"
printf "\n\n"
